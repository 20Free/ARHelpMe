...
public static class FaceDetectionUtils {
    ...
    public static string FaceToString(Face face, string faceColorName)
    {
		...
		sbResult.Append(string.Format("  • Face ID: {0}", face.faceId)).AppendLine();
		...
		sbResult.Append(string.Format("/n"));
...
//		sbResult.Append(string.Format("  • Sideburns: {0}", face.FaceAttributes.FacialHair.Sideburns)).AppendLine();
